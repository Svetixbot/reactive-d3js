...
var svg = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* select */]("#projects"),
    margin = {top: 0, right: 20, bottom: 0, left: 40},
    width = +svg.attr("width") - margin.left - margin.right,
    height = +svg.attr("height") - margin.top - margin.bottom,
    g = svg.append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");

var peoplesvg = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* select */]("#people"),
...
var x = __WEBPACK_IMPORTED_MODULE_0_d3__["e" /* scaleBand */]()
    .rangeRound([0, width])
    .paddingInner(0.05)
    .align(0.1);

var y = __WEBPACK_IMPORTED_MODULE_0_d3__["f" /* scaleLinear */]()
    .rangeRound([height, 0]);

var z = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* scaleOrdinal */]()
...
function renderInitiatives() {
  __WEBPACK_IMPORTED_MODULE_0_d3__["b" /* csv */]("projects.csv", function(d, i, columns) {
    var t = 0;
    ...
    y.domain([0, __WEBPACK_IMPORTED_MODULE_0_d3__["d" /* max */](data, function(d) { return d.total; })]).nice();
    z.domain(keys);
    ...
    g.append("g")
      .selectAll("g")
      .data(__WEBPACK_IMPORTED_MODULE_0_d3__["i" /* stack */]().keys(keys)(data))
      .enter().append("g")
      ...
      .enter().append("rect")
        ...
        .on("mouseover", function(d) {    
              ...
              div .html(d.data.PPM_Name + "<br><br>" + 
                  ...
                  .style("left", (__WEBPACK_IMPORTED_MODULE_0_d3__["c" /* event */].pageX) + "px")   
                  .style("top", (__WEBPACK_IMPORTED_MODULE_0_d3__["c" /* event */].pageY - 28) + "px");  
              })
    ...
    g.append("g")
        .attr("class", "axis")
        .call(__WEBPACK_IMPORTED_MODULE_0_d3__["a" /* axisLeft */](y).ticks(null, "s"))
      .append("text")
        .attr("x", 2)
...
function renderCost() {
  ...
  __WEBPACK_IMPORTED_MODULE_0_d3__["b" /* csv */]("projects.csv", function(d, i, columns) {
    ...
    x.domain(data.map(function(d) { return d.PPM_ID; }));
    y.domain([0, __WEBPACK_IMPORTED_MODULE_0_d3__["d" /* max */](data, function(d) { return parseFloat(d.total); })]).nice();
    z.domain(keys);
...
__WEBPACK_IMPORTED_MODULE_0_d3__["b" /* csv */]("projects.csv", function(d, i, columns) {
  ...
  x.domain(data.map(function(d) { return d.PPM_ID; }));
  y.domain([__WEBPACK_IMPORTED_MODULE_0_d3__["d" /* max */](data, function(d) { return d.total; }), 0]).nice();
  z.domain(keys);
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_21_d3_request__["a"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "i", function() { return __WEBPACK_IMPORTED_MODULE_24_d3_shape__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_31__src_stack__["a"]; });
...
/* unused harmony default export */ var _unused_webpack_default_export = (function() {
  ...
  function mousedowned() {
    ...
    function mousemoved() {
      ...
      g.zoom("mouse", constrain(translate(g.that.__zoom, g.mouse[0] = Object(__WEBPACK_IMPORTED_MODULE_3_d3_selection__["d" /* mouse */])(g.that), g.mouse[1]), g.extent));
    }
